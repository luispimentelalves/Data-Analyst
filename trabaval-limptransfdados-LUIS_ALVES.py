...
def inserir_matricular_formando():
    try:
        ...
        if formando:
            print("NIF já inscrito. Não é possivel fazer uma nova inscrição.")
            return
        ...
        curso_nome = input("Qual o curso em que se pretende inscrever?: ")
...
def pesquisar_formando_por_nome(nome):
    try:
        ...
        if formandos_encontrados:
            ...
            print("Nenhum formand@ encontrad@ com esse nome.")
